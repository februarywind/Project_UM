...
public class PlayerFSM
{
    ...
    public PlayerFSM(PlayerController controller, PlayerCharacterStat characterStat, Animator animator, BattleSkillBase battleSkill, UltimateSkillBase ultimateSkill)
    {
        ...
        playerStates[(int)EPlayerState.Run] = new PlayerRunState(controller, new EPlayerState[] { EPlayerState.Idle, EPlayerState.Dash, EPlayerState.Atack, EPlayerState.Jump, EPlayerState.BattleSkill, EPlayerState.UltimateSkill });
