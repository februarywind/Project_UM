...
public class PlayerFSM
{
    ...
    {
        playerStates[(int)EPlayerState.Idle] = new PlayerIdleState(controller, characterStat, this, animator, new EPlayerState[] { EPlayerState.Walk, EPlayerState.Dash, EPlayerState.Atack, EPlayerState.Jump});
        playerStates[(int)EPlayerState.Walk] = new PlayerWalkState(controller, characterStat, this, animator, new EPlayerState[] { EPlayerState.Idle, EPlayerState.Dash, EPlayerState.Atack, EPlayerState.Jump });
        playerStates[(int)EPlayerState.Run] = new PlayerRunState(controller, characterStat, this, animator, new EPlayerState[] { EPlayerState.Idle, EPlayerState.Dash, EPlayerState.Atack, EPlayerState.Jump});
